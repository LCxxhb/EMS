...
public class PlanController {
    ...
    public String insert(Plan plan) {
        return JSON.toJSONString(planService.insert(plan));
    ...
    public String delete(String id) {
        return JSON.toJSONString(planService.delete(id));
    }
    ...
    public String findAll(Plan plan) {
        return JSON.toJSONString(planService.findAll(plan));
    }
