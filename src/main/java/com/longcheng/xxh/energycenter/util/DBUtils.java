...
public class DBUtils {
    ...
    /** Oracle数据库连接 URL */
    private final static String DB_URL = "jdbc:oracle:thin:@10.5.7.130:1521:orcl";

    /** Oracle数据库连接驱动 */
    private final static String DB_DRIVER = "oracle.jdbc.driver.OracleDriver";

    /** 数据库用户名 */
    private final static String DB_USERNAME = "EMS";

    /** 数据库密码 */
    private final static String DB_PASSWORD = "EMS";
